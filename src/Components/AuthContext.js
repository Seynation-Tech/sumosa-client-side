    ...
    useEffect( () =>
    {
        ...
        const fetchData = async () =>
        {
            try
            {
                ...
                const dieslstock = await axios.get( `${ url }/api/billing/agofuelstock`, {
                    withCredentials: true,
                } );

                const petrolstock = await axios.get( `${ url }/api/billing/pmsfuelstock`, {
                    withCredentials: true,
                } );
                ...
                const lasttotalpetrol = Number( pmone.outputvalue ) + Number( pmto.outputvalue );
                const lasttoataldiesel = Number( agoe.outputvalue ) + Number( agto.outputvalue );
